    ...
    render(){
        return(
            <div style={{overflow:'hidden'}}>
                <div style={{display: 'flex', width: '100%', height: '300px', backgroundColor: '#ffffff'}}>
                ...
                <MediaQuery minDeviceWidth={601} values={{ deviceWidth: 1600 }}> 
                    <div style={{width: '100%', height: '200px', backgroundColor: '#ffffff', padding: '20px', alignContent:'center', alignItems:'center', justifyContent:'center', textAlign:'center'}}>
                ...
                <MediaQuery maxDeviceWidth={600} values={{ deviceWidth: 1600 }}> 
                    <div style={{width: '100%', height: '200px', left: '-10px', backgroundColor: '#ffffff', padding: '20px', paddingLeft:'0px', alignContent:'center', alignItems:'center', justifyContent:'center', textAlign:'center'}}>
                        <p className="heading" style={{fontWeight:'800', color: '#000000', fontSize:'xx-large'}}>WHAT WE DO</p>
