    ...
    render(){
        ...
        <div>
            <MediaQuery minDeviceWidth={0} maxDeviceWidth={600}>            
                <div style={{position:'fixed', top: 0, left: 0, zIndex: 100, width: '100%', height: '50px', paddingTop:'10px', backgroundColor: '#ffffff', borderBottom:'1px solid #ebebeb', alignItems: 'center', alignContent:'center', justifyContent: 'center'}}>
